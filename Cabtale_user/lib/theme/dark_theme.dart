...
ThemeData darkTheme({Color primary = AppConstants.darkPrimary}) => ThemeData(
  ...
  primaryColorDark: const Color.fromARGB(255, 3, 38, 21),
  disabledColor: const Color(0xFFBABFC4),
  scaffoldBackgroundColor: const Color.fromARGB(255, 3, 38, 21),
  ...
  colorScheme: const ColorScheme.dark(
      ...
      secondary: Color.fromARGB(255, 3, 38, 21),
      tertiary: Color.fromARGB(255, 3, 38, 21),
